...
export default function Home() {
  ...
  const handleStartNow = () => {
    router.push('/informacion') // Ruta donde se encuentra la información de los cursos
  }

  return (
    <main className="min-h-screen bg-black text-white py-12 flex flex-col md:flex-row items-center justify-center gap-12">
      <div className="max-w-xl text-center md:text-left">
        ...
        <button
          onClick={handleStartNow}  // Llama la función para redirigir
